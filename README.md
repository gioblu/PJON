...
- **High flexibility**: PJON is totally software-defined and its implementation is designed to be easily hackable and extensible. PJON builds out-of-the-box in all supported devices and can transparently operate on top of any supported protocol or medium.
