...
5. `ACK MODE` bit informs if the [asynchronous](/specification/PJON-protocol-acknowledge-specification-v1.0.md#asynchronous-acknowledge) acknowledgement is requested (value 1) or not (value 0)
6. `ACK` bit informs if the [synchronous](/specification/PJON-protocol-acknowledge-specification-v1.0.md#synchronous-acknowledge) is requested (value 1) or not (value 0)
