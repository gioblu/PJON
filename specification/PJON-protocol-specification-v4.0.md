...
The medium access, collision resolution, transmission and acknowledgement procedures are specified by the underlying layer, which also supplies the maximum number of attempts and the timing required for retransmission.
